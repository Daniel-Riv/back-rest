...
export class ProductCategoryService {
  constructor(private readonly repo = new ProductCategoryRepository()) {}
  ...
  private normalize(data: Partial<ProductCategoryPayload>) {
    return {
  ...
  private validateLengths(data: ReturnType<ProductCategoryService["normalize"]>) {
  ...
  private validateColor(color: string | null) {
    if (!color) return;
  ...
  async create(data: Partial<ProductCategoryPayload>, changedByUserId: number | null) {
  ...
  async update(
    id: number,
    data: Partial<ProductCategoryPayload>,
    ...
    const updateData: Partial<ProductCategoryPayload> = {};
    if (data.nameEs != null) updateData.nameEs = normalized.nameEs;
    if (data.nameEn != null) updateData.nameEn = normalized.nameEn;
    if (data.description != null) updateData.description = normalized.description;
    if (data.icon != null) updateData.icon = normalized.icon;
    if (data.color != null) updateData.color = normalized.color;
